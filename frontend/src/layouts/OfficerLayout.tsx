...
import {
  LayoutDashboard, FileText, Bell, LogOut, Cpu, AlertTriangle
} from 'lucide-react';
import { useAuth } from '../hooks/useAuth';

const navItems = [
  { to: '/officer/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/officer/requests', icon: FileText, label: 'Assigned Requests' },
  { to: '/officer/sla-alerts', icon: AlertTriangle, label: 'SLA Alerts' },
        ...
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-slate-400 text-[10px] mt-0.5">Officer Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-white/10 space-y-1">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-400 text-[10px] truncate">{user?.department}</p>
            </div>
          </div>
